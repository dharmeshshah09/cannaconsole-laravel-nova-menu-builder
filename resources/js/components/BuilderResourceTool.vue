                    ...
                    <form autocomplete="off">
                        ...
                        <div class="flex border-b border-40">
                            ...
                            <div class="py-4 w-4/5">
                                ...
                                >
                                    ...
                                    <option value="link"> {{ __('Placeholder') }} </option>
                                    <option value="route"> {{ __('Category') }} </option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="flex border-b border-40">
                                ...
                                <div class="py-4 w-4/5">
                                    ...
                                    >
                                        ...
                                        <option v-for="cat in categories" v-bind:value="cat.id" :key="cat">{{ cat.name }}</option>
                                    </select>
                                </div>
                            </div>
                            <!-- <div class="flex border-b border-40">
                        ...
                        <div class="flex border-b border-40" v-if="newItem.type">
                            ...
                            <div class="py-4 w-4/5">
                             ...
                             <input type="hidden" class="store_id"  v-model="newItem.store_id" />
                    </form>
                </div>
                <div slot="buttons">
                    <div class="ml-auto">
...
export default {
    ...
    methods: {
        ...
        get_categories(){
            api.get_categories(this.resourceId).then(result => {
                this.categories = _.values(result);
            });
        },
        
        get_store_id(){
            api.get_store_id(this.resourceId).then(result => {
                this.newItem.store_id = String(result);
                console.warn('store_id',result)
            });
        },
        ...
        editMenu(item) {
            api.edit(item.id).then(result => {
                ...
                this.newItem = result;
                if(this.newItem.category != null)
                {
                    this.newItem.type = 'route'
                }
                else if(this.newItem.placeholder != null)
                {
                    this.newItem.type = 'link';
                }
                this.modalItem = true;
            });
        },
